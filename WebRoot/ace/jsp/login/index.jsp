							...
							<div id="login-box"
								...
								<div class="widget-body">
									<div class="widget-main">
										...
										<form action="../login/login" name="loginform" accept-charset="utf-8"
											class="loginForm" method="post">
											<fieldset>
												<label class="block clearfix"> <span
													class="block input-icon input-icon-right"> <input
														type="text" class="form-control" placeholder="User"
														name="user" /> <i class="ace-icon fa fa-user"></i>
												</span>
								...
								<div class="widget-body">
									...
									<div class="toolbar center">
										<a href="#" data-target="#login-box"
											class="back-to-login-link"> 返回到登录 <i
											class="ace-icon fa fa-arrow-right"></i>
										</a>
									</div>
								</div>
								...
								<div class="widget-body">
									...
									<div class="toolbar center">
										<a href="#" data-target="#login-box"
											...
											class="ace-icon fa fa-arrow-left"></i> 返回到登录
										</a>
									</div>
								</div>
								<!-- /.widget-body -->
...
<![endif]-->
	<script type="text/javascript">
		if ('ontouchstart' in document.documentElement)
			document.write("<script src='<%=application.getInitParameter("assetsurl")%>/js/jquery.mobile.custom.min.js'>"
							+ "<"+"/script>");
	</script>
