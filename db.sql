...
INSERT INTO `devlog` VALUES (1,'1.0.0',2016,1440259200,'第一个版本发布。');

INSERT INTO `devlog` VALUES (2,'1.0.1',2016,1440259200,'修改cookie过于简单的安全风险。');
...
INSERT INTO `setting` VALUES ('sitename','myssm',0,''),('title','myssm',0,''),('keywords','关键词',0,''),('description','网站描述',0,''),('footer','2016©myssm',0,''),('test','测试',1,'测试变量');
